  ...
  return (
    <header className='fixed top-0 left-0 w-full z-50 pt-5 px-5'>
      <div className='max-w-full mx-auto flex items-center h-[52px]'>
        ...
        <nav className={`relative hidden lg:flex items-center h-full rounded-full bg-sennheiser-gray transition-all duration-700 ease-in-out ${isScrolled ? 'px-4' : 'px-8'}`}>
