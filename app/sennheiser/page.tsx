      ...
      <main data-nav-color='dark' className='flex h-[90vh] w-full overflow-hidden'>
        ...
        <div className='w-1/2 flex flex-col h-full bg-white relative px-6 pb-6'>
          ...
          <div className='w-full flex-shrink-0 pt-0 relative z-20'>
            ...
            <button className='cursor-pointer bg-black text-white px-8 py-4 rounded-full text-[0.65rem] font-medium flex items-center space-x-2 hover:bg-brand-blue transition-all w-fit group uppercase tracking-widest'>
          ...
          <div className='absolute bottom-6 right-6 flex items-center space-x-6 z-30'>
            ...
            <div className='flex space-x-2'>
              <button onClick={prevSlide} className='cursor-pointer group w-[54px] h-[54px] rounded-full bg-sennheiser-gray flex items-center justify-center hover:bg-brand-blue transition-all duration-300'>
                <ChevronLeft className='w-5 h-5 text-dark-gray group-hover:text-white transition-colors' />
              </button>
              <button onClick={nextSlide} className='cursor-pointer group w-[54px] h-[54px] rounded-full bg-sennheiser-gray flex items-center justify-center hover:bg-brand-blue transition-all duration-300'>
      ...
      <section className='w-full bg-white py-6 px-6 border-light-gray'>
        <div className='max-w-full mx-auto flex flex-col md:flex-row gap-5'>
          ...
          <div className='w-full md:w-1/2 flex flex-col'>
            ...
            <button className='cursor-pointer group mt-6 bg-black text-white px-8 py-4 rounded-full text-[0.65rem] font-medium w-fit flex items-center space-x-2 hover:bg-brand-blue transition-colors uppercase tracking-widest'>
