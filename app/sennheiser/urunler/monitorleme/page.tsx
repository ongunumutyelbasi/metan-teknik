...
export default function MonitorlemePage() {
    const PAGE_CATEGORY = "Monitörleme";
    
    const allowedSysParts = ["Aksesuarlar", "Bodypacks", "Monitoring", "Setler", "Vericiler"];
    const displaySysParts = SYSTEM_PART.filter(part => allowedSysParts.includes(part));
    ...
    const FILTER_CONFIG = [
        ...
        { id: 'systemPart', title: 'Sistem Parçası', options: displaySysParts },
        { id: 'audioSource', title: 'Ses kaynağı', options: AUDIO_SOURCE },
        { id: 'productType', title: 'Ürün Tipi', options: PRODUCT_TYPE },
    ] as const;
    ...
    const relatedSeries: FamilyCard[] = [
        { title: "2000 Series", description: "Net Duyun. Kolayca Cevaplayın. Canlı Etkileşime Geçin.", image: "/images/sennheiser/toplanti-ve-konferans-sistemleri/mobileconnect.avif", href: "/ev" },
        { title: "Kulak-İçi Monitörleme Çözümleri", description: "Net Duyun. Kolayca Cevaplayın. Canlı Etkileşime Geçin.", image: "/images/sennheiser/kablosuz-sistemler/related-series/ewdp.png", href: "/ev" },
        { title: "XS Wireless", description: "Net Duyun. Kolayca Cevaplayın. Canlı Etkileşime Geçin.", image: "/images/sennheiser/kablosuz-sistemler/related-series/spectera.avif", href: "/ev" },
        ...
        { title: "Evolution Wireless-Digital Portable (EW-DP)", description: "Net Duyun. Kolayca Cevaplayın. Canlı Etkileşime Geçin.", image: "/images/sennheiser/kablosuz-sistemler/related-series/spectera.avif", href: "/ev" },
    ];
    ...
    return (
        <div className="min-h-screen bg-white font-sennheiser selection:bg-black selection:text-white">
            ...
            <CategoryHero 
                title="Monitörleme"
                subtitle="Kablosuz ses monitör sistemleri ile özgür kalın ve anı yaşayın"
                imageSrc="/images/sennheiser/monitorleme/monitorleme-hero.png"
            />

            {/* 2. Main Product Info Area */}
            <main className="flex w-full">
                <div className="px-[20px] pt-[20px] antialiased subpixel-antialiased">
                    <Breadcrumbs category="Monitörleme" categoryHref="/sennheiser/urunler/monitorleme" className="mb-0" />
                </div>
            </main>
