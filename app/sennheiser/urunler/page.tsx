  ...
  return (
    <div className='min-h-screen bg-white text-[#1a1a1a] font-sennheiser selection:bg-black selection:text-white'>
      <main className='flex w-full'>
        ...
        <div className='w-1/2 bg-sennheiser-light-gray relative border-r border-gray-100'>
            ...
            <div className='absolute bottom-6 right-6 flex items-center gap-6 z-30'>
              ...
              <div className='flex gap-2'>
                <button
                  ...
                  className='w-[54px] h-[54px] rounded-full bg-sennheiser-very-light-gray flex items-center justify-center transition-all duration-300 hover:bg-brand-blue group cursor-pointer disabled:opacity-30 disabled:pointer-events-none'
                >
                  <svg width='12' height='12' viewBox='0 0 32 32' className='transition-colors duration-300 fill-sennheiser-dark-gray group-hover:fill-white'>
          ...
          <div className='h-screen flex flex-col px-16 pt-20 justify-center'>
            ...
            <nav aria-label='Breadcrumb navigation' className='flex items-center gap-2 mb-8 text-[13px] text-[#666] font-normal'>
              <button className='group flex items-center cursor-pointer'>
                <svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' fill='none' viewBox='0 0 24 24' className='transition-colors duration-200 group-hover:text-brand-blue'>
                   <path fill='currentColor' d='M19.5 9.75 12 2.25l-7.5 7.5V21h5.25v-7.5h4.5V21h5.25z'></path>
                </svg>
              </button>
              <span>/</span>
              <span className='hover:text-brand-blue cursor-pointer transition-colors duration-200'>Products</span>
              <span>/</span>
              <span className='hover:text-brand-blue cursor-pointer transition-colors duration-200'>Microphones</span>
              <span>/</span>
            ...
            <div className='flex items-center gap-[6px]'>
              <button className='flex items-center justify-center rounded-full bg-black text-white hover:bg-brand-blue transition-colors uppercase text-[11px] font-semibold tracking-wider w-[140px] h-[54px]'>
                Add to cart
              </button>
              <button className='w-[54px] h-[54px] rounded-full bg-sennheiser-very-light-gray flex items-center justify-center hover:bg-gray-200 transition-all'>
                <svg width="16" height="16" viewBox="0 0 20 20" fill="none"><path d="M14.6874 15.9125L13.0374 10.8313L17.0687 8.09377L16.8749 7.50002H11.8749L10.3124 2.80627H9.6874L8.1249 7.50002H3.1249L2.93115 8.09377L6.9624 10.8313L5.3124 15.9125L5.8124 16.2875L9.9999 13.2688L14.1874 16.2875L14.6874 15.9125Z" fill="#545252"></path></svg>
              </button>
            </div>
          </div>

          <div className='px-16 pb-32 border-t border-gray-50 pt-16 font-normal'>
            <div className='max-w-full text-[17px] leading-[1.6] text-[#666] space-y-6'>
