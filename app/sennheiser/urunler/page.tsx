    ...
    >
            ...
            <div className="absolute bottom-8 right-8 flex items-center gap-6 z-30">
              ...
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className="w-[54px] h-[54px] rounded-full bg-white flex items-center justify-center transition-all duration-300 hover:bg-brand-blue group cursor-pointer disabled:cursor-default disabled:hover:bg-white"
                >
                  <svg 
                    width="12" 
                    height="12" 
      ...
      <section className="py-24 bg-[#f6f6f7] px-8 lg:px-24 border-t border-gray-100">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16">
            <button className="flex items-center space-x-3 text-[12px] font-bold border-b-2 border-black pb-1 hover:text-gray-500 transition-all uppercase tracking-regular">
