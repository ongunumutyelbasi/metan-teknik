...
export default function YazilimPage() {
    ...
    const FILTER_CONFIG = [
        { 
            id: 'applicationTypes', 
            title: 'Uygulama türü', 
            options: APPLICATION_TYPES as unknown as string[] 
        },
    ] as const;
    ...
    const PAGE_CATEGORY = "Yazılımlar";
    ...
    return (
        <div className="min-h-screen bg-white font-sennheiser selection:bg-black selection:text-white">
            ...
            <CategoryHero 
                title="Yazılımlar"
                subtitle="Kontrolü ve yaratıcılığı ellerinize bırakan üstün imkanlar"
                imageSrc="/images/sennheiser/yazilimlar/yazilimlar-hero.png"
            />

            {/* 2. Main Product Info Area */}
            <main className="flex w-full">
                <div className="px-[20px] pt-[20px] antialiased subpixel-antialiased">
                    <Breadcrumbs category="Yazılımlar" categoryHref="/sennheiser/urunler/yazilimlar" className="mb-0" />
                </div>
            </main>
            ...
            <section className="px-[20px] pt-[60px] antialiased subpixel-antialiased">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[1rem]">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 p-[.6rem] flex flex-col justify-between text-white">
                            <div>
                                <h3 className="antialiased subpixel-antialiased text-[1rem] font-medium leading-tight mb-0">Room Planner</h3>
                                <p className="antialiased subpixel-antialiased text-[1rem] opacity-75 font-medium max-w-full leading-[1.2rem]">
